...
if modo == "🎓 Tutor Interactivo de Problemas":
    ...
    if st.session_state.paso_tutor == "inicio":
        ...
        perimetro = 100.0
        st.info(f"🏞️ **Problema Activo:** Se dispone de **{perimetro} metros** de cerca para cercar un terreno rectangular aprovechando un muro largo ya existente como uno de sus lados (no requiere cerca en ese lado).")
